...
LATENCY = Histogram('latency_seconds_handler', 'считает задержки', labelnames=['handler'], buckets=BUCKETS)
...
REQUESTS_TOTAL = Counter('http_request_total', 'Кол-во запросов к серверу', labelnames=['handler', 'status_code'])
